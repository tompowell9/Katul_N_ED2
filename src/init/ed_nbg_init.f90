   ...
   do ipy=1,cgrid%npolygons
      ...
      do isi=1,cpoly%nsites
         ...
         case (0)
            ...
            csite%slow_soil_N        (1) = 0.0!ATT

         case (1)
         !   csite%fast_soil_C        (1) = 0.2!0.2
         !   csite%slow_soil_C        (1) = 4.0!0.2!7.0!8.6!20!0.01
         !   csite%structural_soil_C  (1) = 0.9!1.5!10.0
        !    csite%structural_soil_L  (1) = csite%structural_soil_C (1)
        !    csite%mineralized_soil_N (1) = 0.01725! 0.15!1.0 ATT
        !    csite%fast_soil_N        (1) = 0.03795!0.3!0.015!0.15!1.0 ATT
        !    csite%slow_soil_N        (1) = 0.03795!ATT
...
subroutine init_nbg_cohorts(csite,lsl,ipa_a,ipa_z)
   ...
   patchloop: do ipa=ipa_a,ipa_z
      ...
      pftloop: do ipft = 1,n_pft
         ...
         !                             * salloci
 !XXT  use new allometric equations
         cpatch%broot(ico)             = q(ipft) * cpatch%bleaf(ico)
         cpatch%bsapwood(ico)          = dbh2bs(cpatch%dbh(ico),ipft)
         cpatch%balive(ico)            = cpatch%bleaf(ico) + cpatch%broot(ico) +             &
                                         cpatch%bsapwood(ico)
!         cpatch%bstorage_min(ico)     = cpatch%bleaf(ico) + cpatch%broot(ico)
!         cpatch%nstorage(ico)         = 0.0
!         cpatch%nstorage_min(ico)     = cpatch%bstorage_min(ico) /  c2n_leaf(ipft)
