...
subroutine load_ed_ecosystem_params()
   ...
   pft_name16(21) = 'Trembling Aspen '
   pft_name16(22) = 'Black Spruce    '
   pft_name16(23) = 'XXX             '
   pft_name16(24) = 'XXX             '
   pft_name16(25) = 'XXX             '
...
subroutine init_met_params()
   ...
   atm_shv_max = 3.7e-2!3.2e-2 ATT   ! That corresponds to a dew point of 32°C at 1000hPa.
...
subroutine init_can_rad_params()
   ...
   leaf_reflect_vis(21:29) = 1.1d-1
   leaf_reflect_vis(23:35)   = 0.061 ! from Milly et al. 2014 same as LM3.1 !1.3d-1 ! 6.2d-2
   									 ! also Castro-Esau et al. 2006
									 ! Avalos et al. 1998
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   leaf_reflect_nir(21:29) = 5.77d-1
   leaf_reflect_nir(23:35)   = 5.20d-1    !  Castro-Esau et al. 2006, Kalascka et al. 2005
   !---------------------------------------------------------------------------------------!
   ...
   wood_reflect_vis(21:35) = 1.60d-1
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   wood_reflect_nir(21:35) = 3.90d-1
   !---------------------------------------------------------------------------------------!
   ...
   leaf_trans_vis(21:29) = 1.60d-1
   leaf_trans_vis(23:35) = 6.0d-2  ! Castro-Esau et al. 2006
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   leaf_trans_nir(21:35) = 2.48d-1
   leaf_trans_nir( 23:35) = 4.0d-1  ! Castro-Esau et al. 2006
   !---------------------------------------------------------------------------------------!
   ...
   !---------------------------------------------------------------------------------------!
   !----- Visible (PAR). ------------------------------------------------------------------!
   leaf_scatter_vis(1:35) = leaf_reflect_vis(1:35) + leaf_trans_vis(1:35) 
   wood_scatter_vis(1:35) = wood_reflect_vis(1:35) + wood_trans_vis(1:35)
   !----- Near infrared. ------------------------------------------------------------------!
   leaf_scatter_nir(1:35) = leaf_reflect_nir(1:35) + leaf_trans_nir(1:35)
   wood_scatter_nir(1:35) = wood_reflect_nir(1:35) + wood_trans_nir(1:35)
   !---------------------------------------------------------------------------------------!
   ...
   leaf_emis(21)    = 9.50d-1
   leaf_emis(22)    = 9.70d-1
   leaf_emis(23:35) = 9.50d-1
   ...
   wood_emis(21)    = 9.00d-1
   wood_emis(22)    = 9.00d-1
   wood_emis(23:35) = 9.00d-1
   !---------------------------------------------------------------------------------------!
...
subroutine init_pft_photo_params()
   ...
   Vm_low_temp(21)           =  4.7137
   Vm_low_temp(22)           =  0.5
   Vm_low_temp(23:35)        =  8.0
   ...
   Vm_high_temp(21:35)       =  45.0  + thioff
   ...
   cuticular_cond(21)        = 20000.0
   cuticular_cond(22)        = 1000.0
   cuticular_cond(23:35)     = 10000.0

!slope of photosynthesis increasing with light
   ...
   quantum_efficiency(21:29) = 0.080
   quantum_efficiency(30:35) = 0.070 ! 0.08  * alphafact
   ...
   !---------------------------------------------------------------------------------------!
!   water_conductance(1:29)  = 250./ yr_sec!450. / yr_sec ! 150. / yr_sec * kfact
 !  water_conductance(30:35) = 450. / yr_sec ! 150. / yr_sec * kfact
   !---------------------------------------------------------------------------------------!
...
print*,'TLP',TLP(23:30)
   ...
   leaf_width(21:22) = 0.05
   leaf_width(23:35) = 0.20
   !---------------------------------------------------------------------------------------!
...
!   resp_temperature_increase = 0.0757
   ...
   resp_opt_water            = 0.95!TEM parameterization !0.95 ED2
   resp_water_below_opt      = 2.2 
   resp_water_above_opt      = 2.2
   resp_temperature_increase = 0.092 !0.069!ATT from Euskirchen et al 2009 !0.092 ED2 !
...
subroutine init_pft_resp_params()
   ...
   root_turnover_rate(6)          = 0.7 !Gill 2000 et al !3.9272 ! 0.333
   ...
   f_labile(17)                   = 0.79
   f_labile(18:20)                = 1.0
   f_labile(21)                   = 1.0!0.79
   f_labile(22)                   = 1.0!0.79
   f_labile(23:30)                = 1.0
...
!   seedling_mortality(4)  = 0.97
   ...
   treefall_s_ltht(6:11)    = 0.10!0.10
   treefall_s_ltht(12:15)   = 0.25
   treefall_s_ltht(16)      = 0.25
   treefall_s_ltht(17)      = 0.10
   treefall_s_ltht(18:20)   = 0.10
   treefall_s_ltht(21)      = 0.10!2.0 !0.10
   treefall_s_ltht(22)      = 0.10!2.0!0.10
   treefall_s_ltht(23:35)   = 0.10
...
!!!!!treefall_s_ltht(:) = 0.0
   ...
   plant_min_temp(21)       = t00-60.0
   plant_min_temp(22)       = t00-80.0
   plant_min_temp(23:35)    = t00+2.5
...
subroutine init_pft_alloc_params()
   ...
   is_tropical(21:22) = .false.
   is_tropical(23:35) = .true.
   !---------------------------------------------------------------------------------------!
   ...
   rho(6:11)  = 0.34500 !Aspinwall 2011  ! Currently not used
   rho(12:13) = 0.20
   rho(14:15) = 0.20
   rho(16)    = 0.20
   rho(17)    = 0.54
   ...
   !print*,'leaf_turnover_rate',leaf_turnover_rate
   ...
   SRA(1:35)     = 24. * 2.  ! m2/kgC Amazon data, fertile soil from Metcalfe et al. 2008
   ...
   horiz_branch(21)    = 0.57
   horiz_branch(22)    = 0.61
   horiz_branch(23:35) = 0.57
   !---------------------------------------------------------------------------------------!
...
!   q(4)     = 1.0
   ...
   !---------------------------------------------------------------------------------------!
   init_density(1)     = 0.1
   init_density(2)     = 0.244875
   init_density(3)     = 0.697625 
   init_density(4)     = 0.422125 
   init_density(5)     = 0.1
   ...
   hgt_ref(17)    = 0.0
   hgt_ref(18:20) = 0.0
   hgt_ref(21)    = 0.2111!Yarie+BL fit!0.74 Bond Lamberty!0.5 Yarie
   hgt_ref(22)    = 0.5601!Yarie+BL fit! 0.41 Bond Lamberty!0.64 Yarie
   hgt_ref(23:35) = 0.0
   ...
   b1Bl(17)    = 0.0
   b1Bl(18:20) = 0.0
   b1Bl(21)    = 0.0014 * 2.!Yarie+BL fit!0.006387!Yarie!0.0030 Bond Lamberty 2002!0.0028!test!
   b1Bl(22)    = 0.022 * 1.1!Yarie+BL fit!0.1208!Yarie!0.0461 Bond Lamberty 2002
   b1Bl(23:35) = 0.0
   ...
   b2Bl(17)    = 0.0
   b2Bl(18:20) = 0.0
   b2Bl(21)    = 2.5975!Yarie+BL fit!2.0!Yarie!2.3527 Bond Lamberty 2002
   b2Bl(22)    = 2.0485!Yarie+BL fit!1.2231!Yarie!1.8172 Bond Lamberty 2002
   b2Bl(23:35) = 0.0
   ...
   b1Bs_small(1:4)   = 0.0 
   b1Bs_small(5)     = 1.0e-5
   b1Bs_small(6)     = 0.0792/0.8*0.9 !Drake 2010
   b1Bs_small(7)     = 0.147
   b1Bs_small(8)     = 0.1617
   ...
   b1Bs_small(21)    = 0.0255!Yarie+BL fit!0.1474!Bond Lamberty! 0.061 Yarie
   b1Bs_small(22)    = 0.0404!Yarie+BL fit!0.1410!Bond Lamberty!.1449 Yarie
   b1Bs_small(23:35) = 0.0
   !----- DBH-stem allometry slope [dimensionless]. ---------------------------------------!
   b2Bs_small(1:4)   = 0.0
   b2Bs_small(5)     = 1.0
   b2Bs_small(6)     = 2.4349 !Dan
   b2Bs_small(7)     = 2.238
   b2Bs_small(8)     = 2.1536
   ...
   b2Bs_small(21)    = 2.8440!Yarie+BL fit!2.2965!BondLamberty!2.4806 Yarie
   b2Bs_small(22)    = 2.6587!Yarie+BL fit!2.3170!BondLamberty!2.1322 Yarie
   b2Bs_small(23:35) = 0.0
   !---------------------------------------------------------------------------------------!
   ...
   b1Ca(21:22) = 2.490154
   b1Ca(23:35) = exp(-1.853) * exp(b1Ht(23:35)) ** 1.888
   !----- Slope.  -------------------------------------------------------------------------!
   ...
   case (0:2)
      ...
      b1Rd(21)    = -1.0!- 0.1!- 1.0!- exp(0.545 * log(10.))
      b1Rd(22)    = -0.30!- 0.0757 !- 0.300!- exp(0.545 * log(10.))
      b1Rd(23:35) = - exp(0.545 * log(10.))
...
c2n_slow       = 63.0!10.0  ! Carbon to Nitrogen ratio, slow pool.
...
subroutine init_pft_leaf_params()
   ...
   clumping_factor(21)    = 8.400d-1
   clumping_factor(22)    = 7.350d-1
   clumping_factor(23:35) = 8.400d-1
...
!   nonlocal_dispersal(4) = 0.074
   ...
   nonlocal_dispersal(21)  = 0.95
   nonlocal_dispersal(22)  = 0.10
   nonlocal_dispersal(23:35) = 1.0
...
subroutine init_pft_derived_params()
   ...
   do ipft = 1,n_pft
      ...
      balive_min = bleaf_min * (1.0 + q(ipft)) * 2. + dbh2bs(dbh,ipft)
      ...
      balive_max  = bleaf_max * (1.0 + q(ipft)) * 2 + dbh2bs(huge_dbh,ipft)
      !------------------------------------------------------------------------------------!
...
subroutine init_soil_coms
   ...
   real   , parameter :: soilcp_MPa = 4.0     ! soil-water pot. for air dry soil   [   MPa]
...
subroutine init_phen_coms
   ...
   dl_tr                    = 810.0!776.0!655.0
   st_tr1                   = 284.3
   st_tr2                   = 275.15
  
   phen_a                   = -68.0!95.9!36.4!-68.0 ATT calculated for paper birtch in fairbanks
   phen_b                   = 638.0! 639.4!320.4!638.0
   phen_c                   = -0.01!-0.052!-0.01
...
subroutine init_rk4_params()
   ...
   effarea_transp(21)   = 1.d0
   effarea_transp(22)   = 2.d0
   effarea_transp(23:35)= 1.d0
   !---------------------------------------------------------------------------------------!
