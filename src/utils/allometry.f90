...
module allometry
  ...
  !=======================================================================================!
  !=======================================================================================!
  real function dbh2bs(dbh,ipft)
        use pft_coms   , only : C2B      &
                              , qsw      &
                              , b1Bsap   &
                              , b2Bsap
        implicit none
        ...
        select case (ipft)
                ...
                case default
                        dbh2bs = qsw(ipft) * dbh2bl(dbh,ipft) * dbh2h(ipft,dbh)
        end select
  ...
  !=======================================================================================!
   ...
   integer function dbh2krdepth(hgt,dbh,ipft,lsl)
      ...
      case (0:2)
        ...
        ! select case (ipft)!ATT
        ! case(21:22)
        !    root_depth = b1Rd(ipft)  * min(dbh,10.0) ** b2Rd(ipft)
        ! end select
