...
subroutine read_ed10_ed20_history_file
   ...
   real                 , dimension(huge_patch)           :: slsn !ATT
            ...
            do isi = 1,cpoly%nsites
               ...
               do ip=1,npatches
                  ...
                  if (sitenum(ip) == cpoly%sitenum(isi)) then
                     ...
                     csite%slow_soil_N       (ip2) = slsn(ip)!ATT
         ...
         case default
            ...
            do isi = 1, cpoly%nsites
               ...
               do ip=1,npatches
                  ...
                  csite%slow_soil_N       (ip) = slsn(ip)!ATT
               ...
               if (csite%cohort_count(ipa) /= 0) then
                  ...
                  do ic = 1,ncohorts
                     ...
                     if (trim(csite%pname(ipa)) == trim(cpname(ic) ) .and.                 &
                        ...
                        cpatch%bsapwood(ic2) = dbh2bs(dbh(ic),ipft(ic))
                        cpatch%broot(ic2) = cpatch%bleaf(ic2) * q(ipft(ic))
                        cpatch%balive(ic2) = cpatch%bsapwood(ic2) + cpatch%broot(ic2) + cpatch%bleaf(ic2)
                        ...
                        cpatch%bstorage_min    (ic2) = cpatch%bleaf(ic2) + 	cpatch%broot(ic2)
                        cpatch%nstorage        (ic2) = 0.0
                        cpatch%nstorage_min    (ic2) = cpatch%bstorage_min(ic2)	/ c2n_leaf(ipft(ic))
                        !------------------------------------------------------------------!
