...
module farq_leuning
   ...
   subroutine lphysiol_full(can_prss,can_rhos,can_shv,can_co2,ipft,leaf_par,leaf_temp      &
      ...
      case (3)
         ...
         !-----------ATT seasonal phenology for aspen
      !case (2)
      !   thispft%vm0 = dble(vm0(ipft)) * dble(vm_bar) * umol_2_mol8
      !   thispft%rd0 = dble(rd0(ipft)) * dble(vm_bar) *  umol_2_mol8
      !   print*,'vm0',vm0(ipft),'vm_bar',vm_bar
      ...
      !------------------------------------------------------------------------------------!
    !  print*,'vmout',vmout,'aparms%vm',aparms%vm
      return
   ...
   subroutine comp_photo_tempfun(ipft,leaf_aging_factor,green_leaf_factor)
      ...
      case (0,1)
        ...
        ! print*,'vm_nocorr',vm_nocorr,'thispft%vm0',thispft%vm0,'thispft%vm_hor',thispft%vm_hor
         !---------------------------------------------------------------------------------!
      ...
      case (2,3)
         ...
         !print*,'vm_nocorr',vm_nocorr,'thispft%vm0',thispft%vm0,'thispft%vm_q10',thispft%vm_q10
         !---------------------------------------------------------------------------------!
